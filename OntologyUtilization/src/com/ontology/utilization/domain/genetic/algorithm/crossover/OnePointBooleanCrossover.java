...
public class OnePointBooleanCrossover extends BooleanCrossover {

	private BooleanEstimate booleanEstimate;

	public OnePointBooleanCrossover(int probabilityOfCrossover,
		...
		for (int i = 0; i < parents.size(); i += 2) {
			...
			if (random <= probabilityOfCrossover) {
				...
				for (int cecha = 0; cecha < 9; cecha++) {
					...
					Integer pointOfCut = rGen.nextInt(10);
